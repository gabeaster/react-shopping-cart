...
- [DONE] CD into the project base directory `cd react-shopping-cart`.
...
**DONE Step 1 - Add item functionality**
...
**DONE STEP 2 - Creating ProductContext**
...
**DONE STEP 3 - Providing data with ProductContext**
...
**DONE STEP 4 - Consuming data with ProductContext**
...
**DONE STEP 5 - Create the CartContext**
...
**DONE STEP 6 - Providing data with CartContext**
...
- DONE Create a `ProductContext` and a `CartContext`
- DONE Use the Provider Component from `ProductContext` and `CartContext` to provide data to child components
- DONE Consume data using the `useContext` hook from `ProductContext` and `CartContext`
